  ...
  const renderStep1 = () => (
    <>
      ...
      {/* * MODIFICATION RESPONSIVE *
        Le conteneur .formStep sera une grille sur desktop 
      */}
      <div className={styles.formStep}>
        ...
        {/* * MODIFICATION RESPONSIVE *
          Le .fullWidth prendra 2 colonnes sur desktop
        */}
        <button type="button" className={`${styles.iconButton} ${styles.fullWidth}`}>
          <span className={styles.icon}><MdCameraAlt /></span>
          Prendre une photo
        </button>
        <div className={`${styles.navigationButtons} ${styles.fullWidth}`}>
          <button type="button" className={`${styles.navButton} ${styles.nextButton}`} onClick={nextStep} style={{marginLeft: 'auto'}}>
            Suivant
          </button>
        </div>
      </div>
